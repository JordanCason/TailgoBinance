    ...
    return (
      <HomeStyle>
          <div id='sideNav'>
              ...
              <button type='button' onClick={() => {this.props.settingsAction()}}>settings action</button><br/>
              <button type='button' onClick={() => {this.props.settingsActiongit()}}>settings action</button><br/>
              <br/>
              <br/>
              <a>Auto Trading</a><br/>
